#ifndef SERVICE_COMMON_G
#define SERVICE_COMMON_G

#include <dns_sd.h>

namespace sppvip {

constexpr auto SPPVIP_SERVICE_NAME = "_sspvip._udp";
constexpr int SPPVIP_PORT = 9999;

inline const char*
mdns_error_string(DNSServiceErrorType error)
{
    switch (error) {
